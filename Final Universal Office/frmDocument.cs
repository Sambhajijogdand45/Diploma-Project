...
namespace Ribbonpad
{
	...
	public class frmDocument : DevComponents.DotNetBar.Office2007Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.rtfText.Size = new System.Drawing.Size(1028, 746);
        ...
        public void UpdateBulletStyle(Boolean status)
        {
            this.rtfText.SelectionBullet = status;
        }
		...
		public void OpenFile(string filename)
		{
			...
			if(filename.Substring(filename.Length-4,4).ToLower()==".txt")
                ...
                if (filename.Substring(filename.Length - 4, 4).ToLower() == ".rtf")
